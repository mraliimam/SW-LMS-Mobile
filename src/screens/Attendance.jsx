...
const Attendance = () => {
  ...
  const sortedAttendance = useMemo(
    () => filteredStudents?.sort((a, b) => a.sr_no - b.sr_no) || [],
    [filteredStudents]
  )
          ...
          {isLoading ? (
            ...
            <>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.submitButton,
                  (!allAttendanceMarked || loading || attendanceTaken) && styles.disabledSubmitButton
                ]}
                disabled={!allAttendanceMarked || attendanceTaken || loading}
              >
                {loading ? (

...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, Image, StatusBar, ActivityIndicator } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  iconContainer: {
    width: 70, height: 70, maxWidth: 100, maxHeight: 100, backgroundColor: 'white', borderRadius: 40, justifyContent: 'center', alignItems: 'center', marginBottom: 8, shadowColor: '#000', shadowOffset: {
      width: 0,
      height: 2,
